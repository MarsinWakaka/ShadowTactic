...
public class MonkNinjaSkill : IState
{
    ...
    public MonkNinjaSkill(BasePlayer basePlayer)
    {
    ...
    public void OnEnter()
    {
        ...
        _basePlayer.anim.Play(AnimTags.SKILL);
    ...
    public void OnUpdate()
    {
        ...
        else if (attackCheck) // 攻击阶段可以缓慢移动
        {
            ...
            _basePlayer.rg.velocity = new Vector2(5 * _basePlayer.transform.localScale.x, _basePlayer.rg.velocity.y);
